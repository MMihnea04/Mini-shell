...
This project implements a simplified Unix shell in C. It is designed as an educational exercise focused on process creation, inter-process communication, and implementing a command-line interface. The shell executes built-in commands, external programs, and supports piping and redirection.
